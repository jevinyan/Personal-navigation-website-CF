  ...
  <div v-else class="admin-layout">
    ...
    <main class="admin-main">
      ...
      <footer class="admin-footer">
        <p class="admin-copyright">Copyright © 2026 Personal-navigation | <a href="https://github.com/jevinyan/Personal-navigation-website-CF" target="_blank" class="footer-link">Powered by Jevin</a></p>
      </footer>
    </main>
  </div>
</template>
